...
from dtc_utils import download_url, check_integrity, TransformTwice, RandomTranslateWithReflect
...
def CIFAR100Loader(root, batch_size, split='train', num_workers=2, labeled=True, shuffle=True, aug=None, mode='80_10'):
    ...
    if mode == 'probe':
        dataset = CIFAR100(root=root, split=split, labeled=True, transform=transform, labeled_list=range(80, 90),
                           unlabeled_list=None)
    elif mode == '80_10':
        dataset = CIFAR100(root=root, split=split, labeled=labeled, transform=transform, labeled_list=range(80),
...
if __name__ == "__main__":
    ...
    dataset = CIFAR10(root=image_dataset_root, split='train', labeled=True, transform=None, labeled_list=range(5),
