...
python -W ignore two_DTC_incd_train_tinyimagenet.py \
          --DTC eval \
          --seed 5 \
          --warmup_lr 0.1 \
          --lr 0.05 \
          ...
          --second_step_dir ./data/experiments/two_DTC_incd_train_tinyimagenet/PI/second_DTC_2nd_PI_tinyimagenet.pth
